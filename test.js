...
write()
write("Powers")
testDerive("f(x)^c", "c * f'(x) * f(x)^(c - 1)")
testDerive("c^f(x)", "c^f(x) * f'(x) * ln(c)")
testDerive("f(x)^g(x)", "(f'(x) * g(x) / f(x) + g'(x) * ln(f(x))) * f(x)^g(x)")
write()
...
testDerive("cos(f(x))", "-f'(x) * sin(f(x))")
testDerive("tan(f(x))", "f'(x) * sec(f(x))^2")
testDerive("cot(f(x))", "-csc(f(x))^2 * f'(x)")
testDerive("sec(f(x))", "f'(x) * sec(f(x)) * tan(f(x))")
testDerive("csc(f(x))", "-cot(f(x)) * csc(f(x)) * f'(x)")
write()
write("Inverse trigonometry")
testDerive("asin(f(x))", "f'(x) * sec(asin(f(x)))")
testDerive("acos(f(x))", "-csc(acos(f(x))) * f'(x)")
testDerive("atan(f(x))", "cos(atan(f(x)))^2 * f'(x)")
testDerive("acot(f(x))", "-f'(x) * sin(acot(f(x)))^2")
testDerive("asec(f(x))", "cos(asec(f(x))) * cot(asec(f(x))) * f'(x)")
testDerive("acsc(f(x))", "-f'(x) * sin(acsc(f(x))) * tan(acsc(f(x)))")
write()
write("Hyperbolic functions")
testDerive("sinh(f(x))", "cosh(f(x)) * f'(x)")
testDerive("cosh(f(x))", "f'(x) * sinh(f(x))")
testDerive("tanh(f(x))", "f'(x) * sech(f(x))^2")
testDerive("coth(f(x))", "-csch(f(x))^2 * f'(x)")
testDerive("sech(f(x))", "-f'(x) * sech(f(x)) * tanh(f(x))")
testDerive("csch(f(x))", "-coth(f(x)) * csch(f(x)) * f'(x)")
write()
write("Inverse hyperbolic functions")
testDerive("asinh(f(x))", "f'(x) * sech(asinh(f(x)))")
testDerive("acosh(f(x))", "csch(acosh(f(x))) * f'(x)")
testDerive("atanh(f(x))", "cosh(atanh(f(x)))^2 * f'(x)")
testDerive("acoth(f(x))", "-f'(x) * sinh(acoth(f(x)))^2")
testDerive("asech(f(x))", "-cosh(asech(f(x))) * coth(asech(f(x))) * f'(x)")
testDerive("acsch(f(x))", "-f'(x) * sinh(acsch(f(x))) * tanh(acsch(f(x)))")
write()
